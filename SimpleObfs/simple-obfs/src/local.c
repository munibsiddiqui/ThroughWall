...
simple_obfs_start(profile_t profile, simpleobfs_cb cb, void * data)
{
    ...
    char *ss_remote_host = profile.ss_remote_host;
    char *ss_remote_port = profile.ss_remote_port;
    char *ss_local_host  = profile.ss_local_host;
    char *ss_local_port  = profile.ss_local_port;
    char *ss_plugin_opts = profile.ss_plugin_opts;
